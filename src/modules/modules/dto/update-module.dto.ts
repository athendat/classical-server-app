...
import { ArrayMinSize, IsArray, IsNotEmpty, IsOptional, IsString, IsInt, Min, ValidateNested } from 'class-validator';
import { IsValidActions } from '../validators';
import { ApiProperty } from '@nestjs/swagger';
import { Type, Transform } from 'class-transformer';
import { Permission } from 'src/modules/authz/schemas/permission.schema';
