...
export const SYSTEM_ROLES = [
   ...
   */
  {
    ...
    description: 'Superusuario con acceso ilimitado a todas las operaciones. Wildcard global: *',
    permissionKeys: ['*'],
    status: 'active',
    isSystem: true,
  },
   ...
   */
  {
    key: 'admin',
    name: 'Administrador',
    description: 'Administrador del sistema con acceso a todos los módulos y operaciones estándar',
    permissionKeys: ['*'],
    status: 'active',
    isSystem: true,
  },
