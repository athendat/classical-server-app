...
- **Cross-platform byte parity is locked by shared test vectors** (`src/modules/nfc-payments/test-vectors/nfc-payment-vectors.json`). Any change to the derivation must regenerate them and ship on both platforms together.
